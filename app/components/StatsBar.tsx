    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
      ...
      <div className={card}>
        <div className="min-w-0 flex-1">
          ...
          {/* accidents chip pill */}
          <div className="mt-2 inline-flex items-center gap-2 rounded-full px-2.5 py-1 text-xs
        ...
        <Donut slices={dataset} centerLabel="100%" size={116} /> {/* slightly smaller */}
      </div>
      ...
      <div className={card}>
        <div className="min-w-0 flex-1">
          ...
          <div className="text-xs opacity-70">Based on {range.count} vehicles</div>
          <div className="mt-3">
      ...
      <div className={card}>
        <div className="min-w-0 flex-1">
          ...
          <div className="text-xs opacity-70">Based on {charging.count} vehicles</div>
          <div className="mt-3">
